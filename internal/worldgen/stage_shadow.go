...
// стоит на юго-востоке, поэтому тень уходит на СЕВЕРО-ЗАПАД — вверх и влево, а
// снизу и справа от возвышенности её нет вовсе.
//
// ДЛИНА — ровно одна клетка. Тень читается как тонкая кайма, повторяющая контур
// макушки, а не как размазанное пятно: длинный шлейф закрывал заметную часть
// поляны и спорил с самой возвышенностью.
//
